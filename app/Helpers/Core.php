...
class Core
{
    ...
    public static function DiscountBalance(Wallet $wallet, $bet)
    {
        ...
        \Log::info("Aposta: ".$bet);
        \Log::info("Saldo: ".$wallet->balance);
        \Log::info("Saldo de Saque: ".$wallet->balance_withdrawal);
        \Log::info("Saldo de Saque Sem Bonus: ".$wallet->total_balance_without_bonus);
        \Log::info("Condição: ".($wallet->balance > 0 || $wallet->balance_withdrawal > 0) && $wallet->total_balance_without_bonus < $bet);
